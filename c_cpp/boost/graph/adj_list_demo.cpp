...
// Original post:
// https://github.com/mmccoo/nerd_mmccoo/blob/master/boost_properties/adj_lists.cxx 
...
void example0a() {
    // a simple graph with bundled properties for vertex and a predefined
    // property for the edge. for a list of predefined properties, you can look
    // here:
    // http://www.boost.org/doc/libs/1_64_0/libs/graph/doc/using_adjacency_list.html#sec:adjacency-list-properties
    typedef boost::adjacency_list<boost::vecS, boost::vecS,
                                    boost::undirectedS,
    ...
    // first is the edge. second is a bool telling you whether this is a new
    // edge or an existing one.
    ...
    std::cout << "with name getter " << get(&VertexData::first_name, G)[0] << std::endl;
...
void example3() {
    ...
    // MyGraphType G(); you'll get cryptic/misleading errors if you do.
    MyGraphType G;
