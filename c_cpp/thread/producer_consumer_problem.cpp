...
//compile: g++ -D _REENTRANT producer_consumer_problem.cpp -lpthread
...
// consume item 
// down full, consume, up empty
// What if 'up empty' before 'down full'?
// Then, consumer might consume even when buffer is empty.
